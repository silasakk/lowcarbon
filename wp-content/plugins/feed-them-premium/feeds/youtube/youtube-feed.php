...
function listVideos(data) {
  ...
  for (var i=0; i<data.feed.entry.length; i++) {
	...
	if (vids_in_row=='1') {
	   ...
	   myOutput+='<div class="fts-fluid-videoWrapper"><iframe id="fts-'+vid_id+'" src="http://www.youtube.com/embed/'+entriesID+'?wmode=transparent&HD=0&rel=0&showinfo=0&controls=1&fs=1&autoplay=0" frameborder="0" allowfullscreen></iframe></div>';
	   myOutput += '</li>';
	}
	else	{
	 myOutput += '<li><div class="entriestitle">' + entriesTitle + '</div>';
	  ...
	  myOutput+='<div id="fts-'+vid_id+'" class="fts-yt-overlay-wrap">';
		...
		myOutput+='<div class="fts-fluid-videoWrapper"><iframe id="fts-yt-iframe-'+vid_id+'" class="fts-yt-player" src="http://www.youtube.com/embed/'+entriesID+'?&wmode=transparent&HD=0&rel=0&showinfo=0&controls=1&fs=1" frameborder="0" allowfullscreen></iframe></div>';
	...
	if (largeVid=='yes') {
		if (i==0) {
		  ...
		  firstOutput += '<div class="fts-fluid-videoWrapper"><iframe src="http://www.youtube.com/embed/'+entriesID+'?wmode=transparent&HD=0&rel=0&showinfo=0&controls=1&autoplay=0" frameborder="0" allowfullscreen></iframe></div>';
